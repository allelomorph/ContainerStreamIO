...
template <typename Type> class VectorWrapper : public std::vector<Type>
{
};
...
TEST_CASE("Traits")
{
    ...
    {
        constexpr auto isAContainer =
            ContainerPrinter::Traits::is_printable_as_container_v<std::vector<int>>;
    ...
    {
        constexpr auto isAContainer =
            ContainerPrinter::Traits::is_printable_as_container_v<std::list<int>>;
        REQUIRE(isAContainer == true);
    }
    ...
    {
        constexpr auto isAContainer =
            ContainerPrinter::Traits::is_printable_as_container_v<std::set<int>>;
        REQUIRE(isAContainer == true);
    }
    ...
    {
        constexpr auto isAContainer =
            ContainerPrinter::Traits::is_printable_as_container_v<int[10]>;
        REQUIRE(isAContainer == true);
    }
    ...
    {
        constexpr auto isAContainer =
            ContainerPrinter::Traits::is_printable_as_container_v<std::string>;
    ...
    {
        constexpr auto isAContainer =
            ContainerPrinter::Traits::is_printable_as_container_v<std::wstring>;
        REQUIRE(isAContainer == false);
    }
    ...
    {
        constexpr auto isAContainer =
            ContainerPrinter::Traits::is_printable_as_container_v<VectorWrapper<int>>;
        REQUIRE(isAContainer == true);
    }
}
...
TEST_CASE("Delimiter Validation")
{
    ...
    SECTION("Verify wide character delimiters for a non-specialized container type.")
    {
        constexpr auto delimiters =
            ContainerPrinter::Decorator::delimiters<wchar_t[], wchar_t>::values;
    ...
    {
        constexpr auto delimiters =
            ContainerPrinter::Decorator::delimiters<std::set<int>, char>::values;
        REQUIRE(delimiters.prefix == std::string_view{ "{" });
        REQUIRE(delimiters.separator == std::string_view{ ", " });
        REQUIRE(delimiters.suffix == std::string_view{ "}" });
    }
    ...
    {
        constexpr auto delimiters =
            ContainerPrinter::Decorator::delimiters<std::set<int>, wchar_t>::values;
        REQUIRE(delimiters.prefix == std::wstring_view{ L"{" });
        REQUIRE(delimiters.separator == std::wstring_view{ L", " });
        REQUIRE(delimiters.suffix == std::wstring_view{ L"}" });
    }
    ...
    {
        constexpr auto delimiters =
            ContainerPrinter::Decorator::delimiters<std::pair<int, int>, char>::values;
        REQUIRE(delimiters.prefix == std::string_view{ "(" });
        REQUIRE(delimiters.separator == std::string_view{ ", " });
        REQUIRE(delimiters.suffix == std::string_view{ ")" });
    }
    ...
    {
        constexpr auto delimiters =
            ContainerPrinter::Decorator::delimiters<std::pair<int, int>, wchar_t>::values;
        REQUIRE(delimiters.prefix == std::wstring_view{ L"(" });
        REQUIRE(delimiters.separator == std::wstring_view{ L", " });
        REQUIRE(delimiters.suffix == std::wstring_view{ L")" });
    }
    ...
    {
        constexpr auto delimiters =
            ContainerPrinter::Decorator::delimiters<std::tuple<int, int>, char>::values;
        REQUIRE(delimiters.prefix == std::string_view{ "<" });
        REQUIRE(delimiters.separator == std::string_view{ ", " });
        REQUIRE(delimiters.suffix == std::string_view{ ">" });
    }
    ...
    {
        constexpr auto delimiters =
            ContainerPrinter::Decorator::delimiters<std::tuple<int, int>, wchar_t>::values;
        REQUIRE(delimiters.prefix == std::wstring_view{ L"<" });
        REQUIRE(delimiters.separator == std::wstring_view{ L", " });
        REQUIRE(delimiters.suffix == std::wstring_view{ L">" });
    }
...
TEST_CASE("Printing of Nested Containers")
{
    ...
    SECTION("Printing a populated std::map<...> to a narrow stream.")
    {
        ...
        REQUIRE(
            narrowBuffer.str() == std::string{ "[(1, Template), (2, Meta), (3, Programming)]" });
    }
    ...
    SECTION("Printing a populated std::map<...> to a wide stream.")
    {
        ...
        REQUIRE(
            wideBuffer.str() == std::wstring{ L"[(1, Template), (2, Meta), (3, Programming)]" });
    }
